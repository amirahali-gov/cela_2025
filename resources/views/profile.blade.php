            ...
            <div class="card-body">
                <form name="update-duplicate" id="duplicate" method="post" action="{{ url('duplicate') }}">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="duplicateOptions" id="duplicateYes" value="Y" {{ $applicant->APL_Dup == 'Y' ? 'checked' : '' }}>
                        <label class="form-check-label" for="duplicateYes">Yes</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="duplicateOptions" id="duplicateNo" value="N" {{ $applicant->APL_Dup == 'N' ? 'checked' : '' }}>
    ...
    <section class="mb-4">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-12">
                        <h5 class="text-primary">{{ $applicant->APL_FName }} {{ $applicant->APL_MName }} {{ $applicant->APL_LName }}</h5>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <p class="mb-0">
                            @if ($applicant->APL_BANK == 'Y')
                                Yes<br>
                                Institution: {{ $applicant->APL_BANK_Name == 'OTH' ? $applicant->APL_BANK_Other : $applicant->BANK_Desc }}<br>
                                ...
                                @if ($uploads !== null)
                                    ...
                                    @foreach ($uploads as $upload)
                                        @if ($upload->UPD_Desc === $type)
                                            ...
                                            <div class="mb-1">
                                                <a href="{{ url('/files/' . $upload->UPD_ID) }}" target="_blank" class="text-decoration-none">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if ($chairman === 0)
                    ...
                    <div class="mb-4">
                        <h5>Add Comments</h5>
                        <textarea name="text" id="comment" class="form-control" rows="4" required>@if ($userComment !== null){{ $userComment->COM_Comment }}@endif</textarea>
                        <div class="mt-2">
                            <button id="adjudication-btn" class="btn btn-primary btn-sm" onClick='setComment({{ $applicant->APL_ID }})'>Submit Comment</button>
                        </div>
                    </div>
                @endif
                ...
                <div class="scoring-section">
                    ...
                    @if ($chairman === 0)
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="text" id="score" type="text" class="form-control" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="text" id="score2" type="text" class="form-control" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="text" id="score3" type="text" class="form-control" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input name="text" id="score4" type="text" class="form-control" 
                                       value="{{ $score->SCR_Score_4 ?? '' }}" 
                                       {{ ($applicant->APL_Dup === 'Y' || $applicant->APL_Scored === 'Y') ? 'disabled' : '' }}>
                                        ...
                                        @foreach ($calculateScores as $com)
                                            <tr>
                                                @if ($chairman === 1)
                                                    ...
                                                    <td><input class="chairmanScore form-control" type="text" value="{{ $com->SCR_Score }}" id="{{ $com->LGN_ID }}Score"></td>
                                                    <td><input class="chairmanScore form-control" type="text" value="{{ $com->SCR_Score_2 }}" id="{{ $com->LGN_ID }}Score2"></td>
                                                    <td><input class="chairmanScore form-control" type="text" value="{{ $com->SCR_Score_3 }}" id="{{ $com->LGN_ID }}Score3"></td>
                                                    <td><input class="chairmanScore form-control" type="text" value="{{ $com->SCR_Score_4 }}" id="{{ $com->LGN_ID }}Score4"></td>
                                                    <td>
                    ...
                    <div class="mt-3">
                        <button id="adjudication-btn" class="btn btn-primary" 
                                onClick='setScore({{ $applicant->APL_ID }})' 
                                {{ ($applicant->APL_Dup === 'Y' || $applicant->APL_Scored === 'Y') ? 'disabled' : '' }}>
                            Submit Score
                        </button>
                    </div>
