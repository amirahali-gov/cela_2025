        ...
        <div id="form-panel">
            ...
            <section>
                ...
                <form action="{{ route('application.apply') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <p><strong>This course will be delivered in two cycles, Tuesday and Thursdays from 3:00pm to 7:00pm.</strong></p>
                    
                    <x-form.radio id="APL_Programme" label="I am interested in attending this course:" :options="[
                        ['Cohort 1: Tuesday 14th and Thursday 16th October 2025', 'Cohort 1'],
                        ['Cohort 2: Tuesday 21st and Thursday 23rd October 2025 ', 'Cohort 2'],
                    ...
                    <div x-data="{ APL_Experience: '{{ old('APL_Experience', '') }}' }">
                        <x-form.radio 
                            id="APL_Experience"
                        ...
                        <div x-show="APL_Experience === 'Y'" x-cloak>
                            <x-form.text-input 
                                ...
                                label="If yes, provide details How long have you been practicing?" 
                                :questionNumber="false"
                            />
                        </div>
                    </div>
