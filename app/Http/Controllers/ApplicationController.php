   ...
   public function apply(Request $request)
    {
        ...
        try {
            ...
            Http::withHeaders([
                ...
                'title' => 'Civic Engagement Leadership Academy 2026',
                'subject' => 'Civic Engagement Leadership Academy 2026 APPLICATION',
                'name' => $name,
                'body' => 'This email serves to inform you that your application has been received.',
                'app' => 'CIVIC ENGAGEMENT LEADERSHIP ACADEMY 2026',
